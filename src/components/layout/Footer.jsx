        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-neutral-400 mb-4 max-w-md">
              Revolutionizing agriculture through AI-powered multi-agent marketplace technology. 
              Connecting producers, exporters, and consumers worldwide with transparency and efficiency.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-neutral-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-neutral-400 text-sm">
              © 2025 AgriConnect. All rights reserved. Developed by Jonnathan Peña.
            </p>
